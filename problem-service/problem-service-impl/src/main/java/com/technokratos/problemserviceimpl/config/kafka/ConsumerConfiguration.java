package com.technokratos.problemserviceimpl.config.kafka;
...
public class ConsumerConfiguration {
    ...
    @Bean
    public NewTopic runResponseTopicDLT() {
        return new NewTopic("run-response-topic-dlt", 2, (short) 1);
    }

    @Bean
    public NewTopic submitResponseTopicDLT() {
        return new NewTopic("submit-response-topic-dlt", 2, (short) 1);
    }

    @Bean
    public NewTopic problemsPublishedResponseTopicDLT() {
        return new NewTopic("problems-published-response-topic-dlt", 2, (short) 1);
    }
